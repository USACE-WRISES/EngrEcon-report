...
*Example*: Compute the future value of a present investment of $800,000 over 30 years with an interest rate of 2.75%.
...
*Example*: Compute the present investment need to obtain a future value of $1,805281 over 30 years with an interest rate of 2.75%.

```{r echo=TRUE}
#future_to_present(i, n, FV)
future_to_present(0.0275,30,1805281)
```
